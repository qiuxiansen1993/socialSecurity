...
const setXiyiContent = (city)=>{
  if(city === '北京'){
    ...
    <p>大话社保平台的优质合作企业可按照“自主就业”的方式与您建立<span class="highlight">规范的劳动关系</span>，并由专业人事顾问为您<span class="highlight">办理工资、个税、社保、公积金等全面的服务</span>。从而帮您在一个城市保持连续的工作履历和社保、工资、个税记录，享受应有的社会福利。
    </p>
    ...
    <p class="text-offset">因此，第一步大话社保平台会推荐您与一家优质的合作企业建立合法合规的劳动关系，通过电子签约方式签订劳动合同。</p>
    <p class="text-bold text-green offset-top offset-bottom highlight">2. 您入职该公司的工作方式是“个人网络承包经营”</p>
    <p class="text-offset">
                您与公司签订《自主就业协议》，承包经营产生收入（如有）扣除少量税费管理费后由您来支配！这是政府倡导的“自主就业”方式之一。您可以理解为，您成为了一个挂靠到一个正规公司下的自由职业者，您可以从事您喜欢的工作，公司为您遮风挡雨，解除后顾之忧。（关于“个人网络承包经营”的工作方式，大话社保后续会提供详细的说明文件，敬请关注。
    </p>
    ...
    <p>感谢您对大话社保的支持与信赖。
          ...
          <p>大话社保平台联合您所在城市的优质人力资源服务企业，为您提供<span class="highlight">规范的社保公积金缴纳、工资个税申报及相关人事服务</span>。无论您是自由职业者、个体创业者还是处于就业空档期，连续的社保、公积金缴纳记录对您都非常重要。我们把您的需求放在第一位，以规范、严谨的服务守护您的权益。
          </p>
    `
  }
}
